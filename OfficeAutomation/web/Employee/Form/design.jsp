                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="${ pageContext.request.contextPath }/designInputServlet" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="ID" id="ID" placeholder="工程号">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">工程名称</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="project" id="project" placeholder="工程名称">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="paper" id="paper" placeholder="图纸张数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="allday" id="allday" placeholder="折合总工日数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="used" id="used" placeholder="所用工日数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">所用工日数</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="used2" id="used2" placeholder="所用工日数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="leaderday" id="leaderday" placeholder="工日">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="${ pageContext.request.contextPath }/designUpdateServlet" method="post">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">工程号</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="ID1" id="ID1" placeholder="工程号">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">工程名称</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="project1" id="project1" placeholder="工程名称">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">图纸张数</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="paper1" id="paper1" placeholder="图纸张数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">折合A1</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="a11" id="a11" placeholder="折合A1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">折合总工日数</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="allday1" id="allday1" placeholder="折合总工日数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">所用工日数</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="used1" id="used1" placeholder="所用工日数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">所用工日数</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="used21" id="used21" placeholder="所用工日数">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">工日</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="leaderday1" id="leaderday1" placeholder="工日">
                                    </div>
                                </div>
