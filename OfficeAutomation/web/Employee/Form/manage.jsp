        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title" style="font-size: 14px;">经营</h6>
                            <h6 class="card-title" style="font-size: 14px;color: red;">填写时请注意，不得使用英文标点符号。</h6>
                            <form class="forms-sample" action="${ pageContext.request.contextPath }/manageInputServlet" method="post">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">商务询价报价</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="quote" id="quote" placeholder="商务询价报价">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">标书制作</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">合同制作与签署</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">投标工作</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="bid" id="bid" placeholder="投标工作">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">设备招标采购</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">设备出厂检测</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">催款（要账）</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="dun" id="dun" placeholder="催款（要账）">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">合同管理</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">其他经营活动</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="others" id="others" placeholder="其他经营活动">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">项目经理</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="managerday" id="managerday" placeholder="项目经理">
                                    </div>
                                </div>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="${ pageContext.request.contextPath }/manageUpdateServlet" method="post">
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">商务询价报价</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="quote1" id="quote1" placeholder="商务询价报价">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">标书制作</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="tender1" id="tender1" placeholder="标书制作">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">合同制作与签署</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="sign1" id="sign1" placeholder="合同制作与签署">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">投标工作</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="bid1" id="bid1" placeholder="投标工作">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">设备招标采购</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="equip1" id="equip1" placeholder="设备招标采购">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">设备出厂检测</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="test1" id="test1" placeholder="设备出厂检测">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">催款（要账）</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="dun1" id="dun1" placeholder="催款（要账）">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">合同管理</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="contract1" id="contract1" placeholder="合同管理">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">其他经营活动</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="others1" id="others1" placeholder="其他经营活动">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" style="font-size: 14px;">项目经理</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="managerday1" id="managerday1" placeholder="项目经理">
                                    </div>
                                </div>
